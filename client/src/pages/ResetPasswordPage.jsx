...
const ResetPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const valErr = validatePasswords();
    if (valErr) {
      setError(valErr);
      setShake(true);
    ...
    try {
      ...
      setIsLoading(false);
      const errMsg = err.response?.data?.message || 'Something went wrong or the link has expired.';
      setError(errMsg);
      toast.error(errMsg);
    }
  };
        ...
        >
          ...
          <div className="text-center max-w-md">
            ...
            <p className="text-base text-slate-400 leading-relaxed">
              Create a secure, strong password that you don't use anywhere else. Make sure it's at least 8 characters long.
            </p>
          </div>
        </motion.div>
